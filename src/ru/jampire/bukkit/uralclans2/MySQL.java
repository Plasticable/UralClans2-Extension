   ...
   public static void connect() {
      try {
         ...
         if(Main.config.getString("database").equalsIgnoreCase("sqlite")) {
            ...
            executeSync("CREATE TABLE IF NOT EXISTS `clan_list` (`id` INTEGER PRIMARY KEY,`name` varchar(255) NOT NULL UNIQUE,`icon` varchar(255),`leader` varchar(255) NOT NULL UNIQUE,`world` varchar(255) NOT NULL,`x` varchar(255) NOT NULL,`y` varchar(255) NOT NULL,`z` varchar(255) NOT NULL,`yaw` varchar(255) NOT NULL,`pitch` varchar(255) NOT NULL,`maxplayers` varchar(255) NOT NULL,`pvp` tinyint(1) NOT NULL, `rname` varchar(255) NOT NULL)");
            ...
            executeSync("CREATE TABLE IF NOT EXISTS `clan_list` (`id` int(11) NOT NULL AUTO_INCREMENT,`name` varchar(255) NOT NULL UNIQUE,`icon` varchar(255),`leader` varchar(255) NOT NULL UNIQUE,`world` varchar(255) NOT NULL,`x` varchar(255) NOT NULL,`y` varchar(255) NOT NULL,`z` varchar(255) NOT NULL,`yaw` varchar(255) NOT NULL,`pitch` varchar(255) NOT NULL,`maxplayers` varchar(255) NOT NULL,`pvp` tinyint(1) NOT NULL, `rname` varchar(255) NOT NULL, PRIMARY KEY (`id`)) DEFAULT CHARSET=utf8 AUTO_INCREMENT=0");
